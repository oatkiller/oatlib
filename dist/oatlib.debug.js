(function () {
var $$_function_prototype, $$Function = Function, $prototype = 'prototype', $$_array_prototype, $$Array = Array, $$_bindings, $$_store, $toString = 'toString', $$RegExp = RegExp, $regex = 'regex', $$_join, $join = 'join', $call = 'call', $string = 'string', $className = 'className', $replace = 'replace', $add_class_name = 'add_class_name', $length = 'length', $each = 'each', $inject = 'inject', $$_slice, $slice = 'slice', $apply = 'apply', $array = 'array', $concat = 'concat', $bind = 'bind', $$null = null, $curry = 'curry', $hasOwnProperty = 'hasOwnProperty', $combine = 'combine', $$true = true, $super_combine = 'super_combine', $for_each = 'for_each', $mask = 'mask', $$Error = Error, $error = 'error', $$false = false, $shift = 'shift', $request = 'request', $readyState = 'readyState', $status = 'status', $onFailure = 'onFailure', $onSuccess = 'onSuccess', $onComplete = 'onComplete', $method = 'method', $GET = 'GET', $async = 'async', $headers = 'headers', $onreadystatechange = 'onreadystatechange', $open = 'open', $url = 'url', $setRequestHeader = 'setRequestHeader', $send = 'send', $post = 'post', $onAbort = 'onAbort', $abort = 'abort', $ajax = 'ajax', $constructor = 'constructor', $injector = 'injector', $builder = 'builder', $chop = 'chop', $style = 'style', $opacity = 'opacity', $filter = 'filter', $clear_opacity = 'clear_opacity', $$_concat, $map = 'map', $$document = document, $createElement = 'createElement', $innerHTML = 'innerHTML', $$_array, $childNodes = 'childNodes', $domarray = 'domarray', $getElementById = 'getElementById', $element = 'element', $object_memo = 'object_memo', $get_once = 'get_once', $$_transition, $getTransition = 'getTransition', $transitions = 'transitions', $push = 'push', $currentTime = 'currentTime', $consider = 'consider', $getCurrentTime = 'getCurrentTime', $getInterval = 'getInterval', $startPlaying = 'startPlaying', $transition = 'transition', $$window = window, $setTimeout = 'setTimeout', $clearTimeout = 'clearTimeout', $setInterval = 'setInterval', $clearInterval = 'clearInterval', $isPlaying = 'isPlaying', $intervalHandle = 'intervalHandle', $iterate = 'iterate', $interval = 'interval', $getStartTime = 'getStartTime', $getEndTime = 'getEndTime', $getDuration = 'getDuration', $durationInSeconds = 'durationInSeconds', $iterator = 'iterator', $scheduleFinalRun = 'scheduleFinalRun', $callback = 'callback', $splice = 'splice', $stopPlaying = 'stopPlaying', $$Date = Date, $getTime = 'getTime', $setupTransition = 'setupTransition', $tearDownTransition = 'tearDownTransition', $set_opacity = 'set_opacity', $fade = 'fade', $appendChild = 'appendChild', $fragment = 'fragment', $take = 'take', $memoize = 'memoize', $$_class_name_test_regex, $test = 'test', $has_class_name = 'has_class_name', $indexOf = 'indexOf', $namespace = 'namespace', $node = 'node', $rcurry = 'rcurry', $remove_class_name = 'remove_class_name', $number = 'number', $supplant = 'supplant', $$String = String, $$_sqrt, $$_asin, $$_abs, $$_PI, $$_sin, $$_pow, $$_cos, $$_transitions, $back = 'back', $ease_in = 'ease_in', $ease_in_out = 'ease_in_out', $ease_out = 'ease_out', $bounce = 'bounce', $circular = 'circular', $cubic = 'cubic', $elastic = 'elastic', $exponential = 'exponential', $linear = 'linear', $quadratic = 'quadratic', $quart = 'quart', $quint = 'quint', $sine = 'sine', $trim = 'trim', $unique = 'unique', emptyString = '';
