...
tests.has_class_name = [
	{
		...
		'test element with a classname, not finding a classname which is a substring of the elements class': function () {
			...
			Assert.isFalse(o.has_class_name(this.element,'nubz'));
		}
	}
];
