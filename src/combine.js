...
(function () {
	...
	$$_combine = o.combine = combinator[o.curry](iterator[o.curry](function (anObj,propertyName) { // curries combinator with a test to make sure the properties are on the subject argument directly, as opposed to being on its prototype
	...
	$$_super_combine = o.super_combine = combinator[o.curry](iterator[o.curry](function () {return true;}));
